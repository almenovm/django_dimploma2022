...
from .views import ProductViewSet, ProductFullViewSet, PublisherListAPIView, PublisherDetailAPIView, SemilarMangaListAPIView, SemilarRanobeListAPIView, MangaViewSet, RanobeViewSet, SemilarMangaDetailAPIView, SemilarRanobeDetailAPIView, MangaFullViewSet, RanobeFullViewSet
...
router.register(r'product', viewset=ProductViewSet, basename='main')
router.register(r'product-dt', viewset=ProductFullViewSet, basename='main')
