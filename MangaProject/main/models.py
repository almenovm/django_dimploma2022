...
from utils.constants import M_TYPE_CHOICES, R_TYPE_CHOICES, COLOR_CHOICES, CATEGORY_CHOICES, TYPE_CHOICES
import datetime
...
class CategoryProduct(models.Model):
    title = models.CharField(max_length=255, null=True, blank=True, verbose_name='Название категории')
...
class TypeProduct(models.Model):
    title = models.CharField(max_length=255, null=True, blank=True, verbose_name='Название типа')
...
class Product(models.Model):
    name = models.CharField(max_length=255, null=True, blank=True, verbose_name='Название')
    price = models.IntegerField(default=0, verbose_name='Цена', null=True)
    category = models.ForeignKey(CategoryProduct, on_delete=models.RESTRICT, verbose_name='Категория', null=True)
    types = models.ManyToManyField(TypeProduct)
    description = models.TextField(null=True, blank=True, verbose_name='Описание')
    image = models.ImageField(upload_to='journal_photos',
                              validators=[validate_size, validate_extension],
