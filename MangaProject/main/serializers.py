...
from main.models import Manga, Ranobe, Publisher, SemilarRanobe, SemilarManga, Author, Product, TypeProduct, CategoryProduct
...
class ProductFullSerializer(ProductSerializer):
    ...
    class Meta:
        model = Product
        fields = ('name', 'price', 'description', 'category', 'types', 'image')
